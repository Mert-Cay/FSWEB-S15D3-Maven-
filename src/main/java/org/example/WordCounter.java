...
public class WordCounter {
    ...
    public static Map<String, Integer> calculatedWord() {
        ...
        // 1. Noktalama işaretlerini temizle (nokta, virgül, tırnak, tire vb. kaldırılır)
        // [.,!?:;\"'’–-] gibi karakterleri boşluk ile değiştiriyoruz
        String cleanedText = text.replaceAll("[.,!?:;\"'’–-]", "").toLowerCase();

        // 2. Bir veya daha fazla boşluk karakterine göre kelimelere böl
        String[] words = cleanedText.split("\\s+");

        // 3. Kelimeleri Map'e ekle ve sayılarını artır (O(n))
